...
<head>
    ...
    <script>
        function clearCar() {
            window.location.href="/qiantai/GoodServlet?reqType=clearCar";
...
<script>
    ...
    $(function () {
        var goodids=document.getElementsByName("goodids");
        var trs=$("#tr").siblings("tr");
        var totalPrice=0;
        for (var i = 1; i <= trs.length; i++) {
            $(".price").attr("id","price"+i);
            $(".amounts").attr("id","amount"+i);
...
<div id="mainNav" class="clearfix">
    <a href="/qiantai/GoodServlet?reqType=main" class="cur">首页<span></span></a>
...
<div class="flowBox">
    ...
    <form id="formCart" name="formCart" method="post" action="/qiantai/GoodServlet">
        ...
        <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
            ...
            <c:forEach items="${car}" var="goodList">
                <tr>
                    <td bgcolor="#ffffff" align="center">${goodList.id}<input type="hidden" name="goodids" value="${goodList.id}"></td>
                    <td bgcolor="#ffffff" align="center">${goodList.gname}</td>
                    <td bgcolor="#ffffff" align="center">${goodList.price}<input type="hidden" class="price" id="" value="${goodList.price}"></td>
                    <td bgcolor="#ffffff" align="center"><input type="text" class="amounts" id="" value="${goodList.num}"/></td>
                    <td bgcolor="#ffffff" align="center">${goodList.price*goodList.num}</td>
                    <td bgcolor="#ffffff" align="center"><a href="/qiantai/GoodServlet?reqType=delCar&goodid=${goodList.id}">删除</a></td>
                </tr>
            </c:forEach>
        </table>
        <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
